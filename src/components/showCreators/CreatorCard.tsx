  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 w-full">
        <h3 className="font-semibold text-lg text-foreground truncate w-full px-2" title={profile.youtube_channel_title || profile.full_name || "Unbekannter Creator"}>
          {profile.youtube_channel_title || profile.full_name || "Unbekannter Creator"}
        </h3>
